  ...
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        ...
        >
          ...
          <p className="mt-6 text-sm text-gray-600">
            Experience the power of AI with Fusion.AI. <br />
        ...
        <div className="flex-1 flex items-start md:justify-end gap-20">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li className="hover:text-gray-800 cursor-pointer" onClick={() => navigate("/")}>Home</li>
              <li className="hover:text-gray-800 cursor-pointer" onClick={() => navigate("/about")}>About us</li>
              <li className="hover:text-gray-800 cursor-pointer" onClick={() => navigate("/contact")}>Contact us</li>
      ...
      <p className="pt-4 text-center text-xs md:text-sm pb-5 text-gray-500">
        Copyright 2025 © Fusion.AI. All Rights Reserved.
      </p>
    </footer>
  );
}
